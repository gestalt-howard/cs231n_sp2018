...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        #############################################################################
        # Derivative of loss function wrt scores 
        dscore = probs
        ...
        # Backpropagate to ReLu output
        dhidden = np.dot(dscore, W2.T)
        # Backpropagate to ReLu input
        ...
        # Store information in grads dictionary
        grads['W1'] = dW1
    ...
    def train(self, X, y, X_val, y_val,
        ...
        """
        num_train = X.shape[0]
        # Define iterations per epoch (ie how many iterations define an epoch).
        # One epoch is a single pass over the entire training set.
        # Since each training iteration utilizes batch_size training samples,
        # it is necessary to define how many training iterations constitute a complete
        ...
        for it in range(num_iters):
            # Each iteration requires a new minibatch
            X_batch = None
            y_batch = None
